...
public class userInput extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userInputDay = (EditText) findViewById(R.id.user_input_day);
        ...
        userInputTime.setText(intent.getStringExtra("timeResult"));
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(title.equals("") || text.equals("") || totalTime.equals("")|| category.equals("") || day.equals("") || month.equals("") || time.equals("") ) {
                    Toast.makeText(userInput.this, "You Didn't Enter All The Fields", Toast.LENGTH_SHORT).show();
                }
                else{
...
//                groceryListItem inputObject = new groceryListItem(title, text, totalTime);
